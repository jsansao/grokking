...
Este repositório contém os códigos-fonte e simulações associados ao artigo **"*Grokking* e Transições de Fase: Uma abordagem pedagógica da Física Estatística do Aprendizado de Máquina"**. 
